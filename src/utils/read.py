...
Originally from: https://github.com/marcpaga/nanopore_utils
"""
import os
...
class ReadData:
    ...
    def __init__(self, read, filename):
        ...
        try:
            ...
            self.start_rel_to_raw = read.get_analysis_attributes('RawGenomeCorrected_000/BaseCalled_template/Events')[
            ...
            try:
                ...
                self.start_rel_to_raw = read.handle['RawGenomeCorrected_000']['BaseCalled_template/Events'].attrs[
                    'read_start_rel_to_raw']
...
def read_fast5(fast5_file, read_ids=None):
    ...
    Returns:
    	A dictionary with read ids as keys and ReadData objects as values.
    """
